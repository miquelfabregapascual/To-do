                        ...
                        <form method="POST" action="{{ route('tasks.store') }}" class="grid grid-cols-1 sm:grid-cols-6 gap-3 items-end">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <textarea
                                    ...
                                    rows="2"
                                    class="w-full mt-1 px-3 py-2 rounded-md bg-gray-800 border border-gray-600 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    placeholder="Detalles, notas o contexto"
                            ...
                            <div class="sm:col-span-1 flex justify-end">
                                <button
                                    type="submit"
                                    class="inline-flex items-center justify-center rounded-md bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-white text-sm font-medium"
                                >
                                    Guardar
                                </button>
                            </div>
                            ...
                            <div class="bg-gray-800/90 border border-gray-700 rounded-lg p-4">
                                <header class="flex items-center justify-between mb-3">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-400">Arrastra desde aquí al calendario para programar o suelta tareas programadas para devolverlas.</p>
                                    </div>
                                ...
                                <div class="space-y-3" data-backlog-list>
                        ...
                        <section class="space-y-6 min-w-0">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                <div class="flex items-center gap-2">
                                    <a
                                        href="{{ route('dashboard', ['week' => ($weekOffset ?? 0) - 1]) }}"
                            ...
                            <div class="overflow-x-auto pb-2">
                                <div class="grid grid-flow-col auto-cols-[minmax(220px,1fr)] md:auto-cols-[minmax(240px,1fr)] xl:auto-cols-[minmax(220px,1fr)] gap-4 min-w-full">
                                    @foreach ($days as $day)
                                        ...
                                        <section
                                            class="bg-gray-800/90 border border-gray-700 rounded-lg p-4 space-y-3 transition-all"
                                        ...
                                        >
                                            ...
                                            <ol class="space-y-3 min-h-[160px]">
                                                @forelse ($dayTasks as $task)
                                                    <li
                                                        class="group bg-gray-700/70 border border-gray-600 rounded-md p-3 overflow-hidden cursor-grab"
                                                        draggable="true"
                                                        data-task-draggable="{{ $task->id }}"
                                                        aria-grabbed="false"
                                                    >
